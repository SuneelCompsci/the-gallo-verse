...
while running:
    ...
    # BODY
    pygame.draw.line(screen, (0, 0, 0), (line_x_adeline + x, line_y_adeline + y),
                     (line_x_adeline + x, line_y_adeline + y + 50), width=5)
    # ARM OVER HEAD
    pygame.draw.line(screen, (0, 0, 0), (line_x_adeline + x + 42, line_y_adeline + y - 40),
                     (line_x_adeline + x, line_y_adeline + y + 30), width=5)
    pygame.draw.line(screen, (0, 0, 0), (line_x_adeline + x + 42, line_y_adeline + y - 40),
                     (line_x_adeline + x + 15, line_y_adeline + y - 50), width=5)
    # OTHER ARM
    pygame.draw.line(screen, (0, 0, 0), (line_x_adeline + x - 40, line_y_adeline + y + 20),
                     (line_x_adeline + x, line_y_adeline + y), width=5)
    pygame.draw.line(screen, (0, 0, 0), (line_x_adeline + x - 40, line_y_adeline + y + 20),
                     (line_x_adeline + x, line_y_adeline + y + 45), width=5)
    # LEGS
    pygame.draw.line(screen, (0, 0, 0), (line_x_adeline + x, line_y_adeline + y + 50),
                     (line_x_adeline + x + 30, line_y_adeline + y + 80), width=5)
    pygame.draw.line(screen, (0, 0, 0), (line_x_adeline + x, line_y_adeline + y + 50),
                     (line_x_adeline + x - 30, line_y_adeline + y + 80), width=5)
    ...
    pygame.draw.rect(screen, (0, 0, 0),
                     (rect_x_henry + x + 15 + x_henry, rect_y_henry + + 200 + y - 20 - y_henry, 3, 20))
    ...
    pygame.draw.polygon(screen, (84, 8, 8),
                        [(240 + x, 151 + y + 200), (260 + x, 115 + y + 200), (288 + x, 151 + y + 200)])
...
while running:
    ...
    suneel_x += sun_speed_suneel

    if suneel_x > WIDTH:
        suneel_x = -30

    pygame.draw.circle(screen, (255, 255, 0), (200 + suneel_x, 100 + suneel_y), 30)

    # Draw the skyscrapers
    Buildings = 5
    for i in range(Buildings):
        building_x_suneel = i * 100
        building_width_suneel = 80
        building_height_suneel = 200
        pygame.draw.rect(screen, (70, 70, 70), (building_x_suneel, HEIGHT - building_height_suneel, building_width_suneel, building_height_suneel))

        # Add windows
        window_width_suneel = 20
        window_height_suneel = 20
        window_spacing_suneel = 30

        for window_y in range(HEIGHT - building_height_suneel + window_spacing_suneel, HEIGHT - window_height_suneel, window_spacing_suneel):
            for window_x in range(building_x_suneel + window_spacing_suneel, building_x_suneel + building_width_suneel - window_width_suneel,
                                  window_spacing_suneel):
                pygame.draw.rect(screen, (255, 255, 255), (window_x, window_y, window_width_suneel, window_height_suneel))
